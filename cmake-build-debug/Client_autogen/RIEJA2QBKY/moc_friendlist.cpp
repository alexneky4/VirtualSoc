...
#include <memory>
#include "../../../Interface/friendlist.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_FriendList_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_FriendList_t qt_meta_stringdata_FriendList = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_FriendList[] = {
...
Q_CONSTINIT const QMetaObject FriendList::staticMetaObject = { {
    ...
    qt_meta_stringdata_FriendList.offsetsAndSizes,
    qt_meta_data_FriendList,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_FriendList_t,
        // Q_OBJECT / Q_GADGET
